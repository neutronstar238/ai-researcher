...
- LLM reviewer checks now require every finding to cite allowed outer local evidence IDs, and the default review token budget is 1600 for reasoning-token models.
