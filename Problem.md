...
- Next action: Broaden sources beyond ArXiv/Semantic Scholar or configure Semantic Scholar API access, improve similarity query generation so four distinct project-start cross-searches are issued, generate paper-structured drafts only after sufficient evidence, and rerun publication audit.
- Linked tasks: `61.1`, `63.1`
