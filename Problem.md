...
- Next action: If warning-free host logs become required, clean or isolate the global Python 3.13 environment outside the repository; do not mutate global site-packages as part of normal project tasks. Future agents should prefer the npm wrapper or CI for user-facing verification logs when this local host warning is distracting.
- Linked tasks: `32.1`, `130.1`, `144.1`
