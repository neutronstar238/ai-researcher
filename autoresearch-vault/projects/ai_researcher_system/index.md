...
- [[projects/ai_researcher_system/progress/task-259-7-2-weak-form-development-smoke|Task 259.7.2 weak-form development smoke]] — the hash-bound candidate and checkpoint path work on development cells; clean PDE scaling is fixed, noisy PDE remains a negative signal, unseen cells remain sealed, and Gate B remains blocked.
